package edu.up.threethirteengame.game.GameFramework;

import edu.up.threethirteengame.game.GameFramework.actionMessage.EndTurnAction;
import edu.up.threethirteengame.game.GameFramework.actionMessage.GameAction;
import edu.up.threethirteengame.game.GameFramework.actionMessage.GameOverAckAction;
import edu.up.threethirteengame.game.GameFramework.actionMessage.MyNameIsAction;
import edu.up.threethirteengame.game.GameFramework.actionMessage.ReadyAction;
import edu.up.threethirteengame.game.GameFramework.actionMessage.TimerAction;
import edu.up.threethirteengame.game.GameFramework.gameConfiguration.GameConfig;
import edu.up.threethirteengame.game.GameFramework.infoMessage.BindGameInfo;
import edu.up.threethirteengame.game.GameFramework.infoMessage.GameOverInfo;
...
import edu.up.threethirteengame.game.GameFramework.infoMessage.StartGameInfo;
import edu.up.threethirteengame.game.GameFramework.utilities.GameTimer;
import edu.up.threethirteengame.game.GameFramework.utilities.Tickable;
...
public abstract class LocalGame implements Game, Tickable {
    ...
    public GamePlayer[] getPlayers() {return this.players;}
